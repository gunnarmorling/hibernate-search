 ...
 */
public class ConnectedRangeMatchingContext implements RangeMatchingContext, FieldCustomizationWithFieldBridgeSupport<RangeMatchingContext> {
	...
	@Override
	public RangeMatchingContext fieldBridge(FieldBridge fieldBridge) {
		for ( FieldContext fieldContext : getCurrentFieldContexts() ) {
