...
*/
public class ConnectedTermMatchingContext implements TermMatchingContext, FieldCustomizationWithFieldBridgeSupport<TermMatchingContext> {
	...
	@Override
	public TermMatchingContext fieldBridge(FieldBridge fieldBridge) {
		for ( FieldContext fieldContext : getCurrentFieldContexts() ) {
